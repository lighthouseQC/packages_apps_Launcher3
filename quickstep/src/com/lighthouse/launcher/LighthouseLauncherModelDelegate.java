package com.lighthouse.launcher;
...
public class LighthouseLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "LighthouseLauncherModelDelegate";
    ...
    public LighthouseLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
