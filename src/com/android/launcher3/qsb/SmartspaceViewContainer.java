...
import com.lighthouse.launcher.LighthouseLauncher;
import com.lighthouse.launcher.LighthouseLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        LighthouseLauncher launcher = (LighthouseLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        LighthouseLauncherModelDelegate delegate = (LighthouseLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        LighthouseLauncher launcher = (LighthouseLauncher) ActivityContext.lookupContext(getContext());
